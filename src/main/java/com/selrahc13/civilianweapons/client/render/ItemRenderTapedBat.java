...
public class ItemRenderTapedBat implements IItemRenderer {

	protected static ModelBaseballBat model = new ModelBaseballBat();
	protected float scale;
	protected float rescale;
	
	public ItemRenderTapedBat() {
		scale = 1.0f;
		rescale = scale;
		CivilianWeapons.logger.info("Registering ItemRendererTapedBat");
	}
	
	public ItemRenderTapedBat(float f) {
		scale = f;
		rescale = scale;
		CivilianWeapons.logger.info("Registering ItemRendererTapedBat");
	}
