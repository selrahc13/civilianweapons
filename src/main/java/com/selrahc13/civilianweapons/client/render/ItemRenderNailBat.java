...
import com.selrahc13.civilianweapons.client.model.ModelNailBat;
...
public class ItemRenderNailBat implements IItemRenderer {

	protected static ModelNailBat model = new ModelNailBat();
	protected float scale;
	protected float rescale;
	
	public ItemRenderNailBat() {
		scale = 1.0f;
		rescale = scale;
		CivilianWeapons.logger.info("Registering ItemRendererNailBat");
	}
	
	public ItemRenderNailBat(float f) {
		scale = f;
		rescale = scale;
		CivilianWeapons.logger.info("Registering ItemRendererBaseballBat");
	}
		...
		switch (type) {
	       case EQUIPPED: // render in third person
		        ...
		        Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(
		        		Reference.MODID.toLowerCase(),"textures/items/SkinBaseballBatTaped.png"));
